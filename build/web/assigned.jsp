<%-- 
    Document   : assigned
    Created on : 28 May, 2020, 4:57:37 PM
    Author     : sujsi
--%>
        ...
        <div class="container  pad-top">
            <%
                try {
                    ...
                    String q = "Select * from appointment where status='assigned'or'acceptd' ";
                    Statement st = c.createStatement();
                    ResultSet rs = st.executeQuery(q);
            %>
            <h1 class="head">Assigned Assignment</h1>
            ...
            <a href="#" onclick="exportTableToExcel('table2', 'Assignedorder')">Export </a>
        </div> <br><br>
        <div class="container  pad-top">
            <%
                try {
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/onfielddb?zeroDateTimeBehavior=convertToNull", "root", "root123");
                    String q = "Select * from appointment where status='accepted' ";
                    Statement st = c.createStatement();
                    ResultSet rs = st.executeQuery(q);
            %>
            <h1 class="head">Accept Assignment</h1>
            ...
            <a href="#" onclick="exportTableToExcel('table4', 'Acceptedorder')">Export </a>
        </div> 
        <!-- Optional JavaScript -->
