    ...
    <a href="../dist/ITservices.war"></a>
        ...
        <script>
            ...
            $(document).ready(function() {
                $(".alt").click(function() {
                    alert("Please Sign up or sign In for booking your service");
                });
            });
        </script>
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    ...
                    <!-- right button-->
                    <a type="button" class="nav-link nav-item text-dark navbar-nav mt-2 mt-lg-0 " data-toggle="modal" data-target="#Client" >Sign In</a>
                </div>
            </nav>
            ...
            <div class="header-section">
                <div class="writearea">
                    ...
                    <p>For Any Type of Computer services just Click the below button and register for it OR
                        call OR Mail</p>
                    <button type="button" class="btn button alt" data-toggle="modal"
                            data-target="#ragistration" >Book your Service</button>
                </div>
            </div>
        </header>

        <!-- Ragistration model-->
        <div class="modal fade" id="ragistration" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="addclient" onsubmit="return validate()" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="clientcontrol" method="post">
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">User ID:</label>
                                <input type="text" class="form-control"  name="userid" placeholder="Enter the email">
                            </div>
                            <div class="form-group">
                                <label for="message-text" class="col-form-label">Password</label>
                                <input type="Password" class="form-control" name="password">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-info"  data-dismiss="modal" data-toggle="modal"
                                        data-target="#ragistration" >Sign UP</button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <input type="submit" class="btn btn-primary" value="submit">
                            </div>
                        </form>
