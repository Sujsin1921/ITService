        ...
        <div class="container  pad-top">
            <%
                try {
                    ...
                    String q = "Select * from appointment where status='Rejected'";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                                    data-whatever="gdjg">ReAssign</button><a href="deleteasmt?id=<%=rs.getString("application_id")%>"><i class="fas fa-trash-alt" style="color:red;font-size: 22px;text-align: center;"></i></a></td>
                    </tr>
